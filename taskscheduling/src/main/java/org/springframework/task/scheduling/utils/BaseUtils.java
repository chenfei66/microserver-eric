package org.springframework.task.scheduling.utils;
...
//            System.out.println(list);
    ...
    public static class StringUtilsSon extends StringUtils{
        ...
        /***
         * 判断str中最后一个字符是否为mark,如果是的话则去除。然后返回去除mark后的字符串
         * @param str 字符串
         * @param mark 标识
         * @return
         */
        public static String removeLastMark(String str, String mark){
            if(mark.equals(str.substring(str.length() - 1))){
...
//        }
    ...
    public static class MapUtils{
        ...
        public static Object mapToPojo(Map<String, Object> map, Class pojoClass){
            return Reflection.mapToPojo(map, pojoClass);
        }

        public static void copyMap(Map<String, Object> map, Object object){
            Class c = object.getClass();
            ...
            for(Method method : methods){
                ...
                if(methodName.contains("get") && (!methodName.equals("getClass"))){
                    try{
                        ...
                        String key = BaseUtils.StringUtilsSon.firstLowerCase(methodName.substring(3, methodName.length()));
                        map.put(key, value);
                    }catch(Exception e){
                        e.printStackTrace();
                    }
        ...
        public static Object mapToPojo(Map<String, Object> map, Class pojoClass){
            ...
            for(Method method : methods){
                ...
                if(methodName.contains("set")){
                    try{
                        String fieldName = StringUtilsSon.firstLowerCase(methodName.substring(3, methodName.length()));
                        method.invoke(pojo, map.get(fieldName));
                    }catch(IllegalAccessException e){
                        e.printStackTrace();
                    }catch(InvocationTargetException e){
                        e.printStackTrace();
